...
LOG_FILE = "results_coef/train_3D_loss_PINN.txt"
MODEL_FILE = "results_coef/Model_3D_loss_PINN.pth"
ERROR_FILE = "results_coef/train_3D_error_loss_PINN.csv"
...
def get_dataset(adr):
    ...
    outputs = df.iloc[23:24, 0:data_length].values
...
def main():
    ...
    dataset, test_outputs_max , test_outputs_min = get_dataset('dataset_coef/dataset_3D_loss_ref.csv') 
    train_size = int(200) 
    valid_size = int(1)
