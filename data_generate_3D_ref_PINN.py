...
def preprocess(inputs, Llk, Rac):
    ...
    inputs_pre[0:,2] = (inputs_pre[0:,2] - np.log10(7e-2)) / (np.log10(7e-2) - np.log10(2e-2))
    inputs_pre[0:,3] = (inputs_pre[0:,3] - np.log10(7e-2)) / (np.log10(7e-2) - np.log10(1e-2))
    inputs_pre[0:,4] = (inputs_pre[0:,4] - np.log10(3e-4)) / (np.log10(3e-4) - np.log10(1e-4))
    inputs_pre[0:,5] = (inputs_pre[0:,5] - np.log10(3e-4)) / (np.log10(3e-4) - np.log10(1e-4))
    inputs_pre[0:,6] = (inputs_pre[0:,6] - np.log10(3e-4)) / (np.log10(3e-4) - np.log10(1e-4))
    inputs_pre[0:,7] = (inputs_pre[0:,7] - np.log10(3e-4)) / (np.log10(3e-4) - np.log10(1e-4))
    inputs_pre[0:,8] = (inputs_pre[0:,8] - np.log10(6e-3)) / (np.log10(6e-3) - np.log10(5e-4))
    inputs_pre[0:,9] = (inputs_pre[0:,9] - np.log10(4e-3)) / (np.log10(4e-3) - np.log10(1e-3))
    inputs_pre[0:,10] = (inputs_pre[0:,10] - np.log10(8.2e-2)) / (np.log10(8.2e-2) - np.log10(2.2e-2))
    inputs_pre[0:,11] = (inputs_pre[0:,11] - np.log10(2.26e-2)) / (np.log10(2.26e-2) - np.log10(5.5e-3))
...
def main():
    ...
    coef = get_loss_model_output(model_loss_IW_Ls, device, data_loader_IW, inputs, 1)
    ...
    save_data_loss = save_data_loss.T
    np.savetxt("dataset_coef/dataset_3D_loss_ref.csv", save_data_loss, delimiter=',')
