...
def main():
    ...
    # unit m
    # Np = np.random.uniform(3, 6, (number, 1))
    # Ns = np.random.uniform(3, 6, (number, 1))
    # hw1 = np.random.uniform(0.1, 0.2, (number, 1))
    # hw2 = np.random.uniform(0.1, 0.2, (number, 1))
    # dw1 = np.random.uniform(0.1, 0.2, (number, 1))
    # dw2 = np.random.uniform(0.1, 0.2, (number, 1))
    # dww_ii_x = np.random.uniform(0.1, 0.2, (number, 1))
    # dww_oo_x = np.random.uniform(0.1, 0.2, (number, 1))
    # dww_x = np.random.uniform(0.1, 0.2, (number, 1))
    # lcore_x1 = np.random.uniform(0.1, 0.2, (number, 1))
    # lcore_x2 = np.random.uniform(0.1, 0.2, (number, 1))
    # lcore_y1 = np.random.uniform(0.1, 0.2, (number, 1))
    # lcore_y2 = np.random.uniform(0.1, 0.2, (number, 1))
    # lcs = np.random.uniform(0.1, 0.2, (number, 1))
    # dcs = np.random.uniform(0.1, 0.2, (number, 1))
